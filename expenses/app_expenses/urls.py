...
urlpatterns = [
    ...
    path('api/manage-expense-from-chat/', views.manage_expense_from_chat_api, name='manage_expense_from_chat_api'),
    path('api/save-income-from-chat/', views.save_income_from_chat_api, name='save_income_from_chat_api'),
    path('api/save-recurring-from-chat/', views.save_recurring_from_chat_api, name='save_recurring_from_chat_api'),
