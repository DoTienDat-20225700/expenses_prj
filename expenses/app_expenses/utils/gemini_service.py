...
def analyze_chat_message(text, history=None):
    ...
    response = client.models.generate_content(
        ...
        contents=(
            ...
            'Chọn EDIT_EXPENSE khi người dùng muốn sửa một khoản chi và DELETE_EXPENSE '
            'khi muốn xóa một khoản chi. Với câu hỏi tra cứu/phân tích, giữ đúng intent '
            'tương ứng thay vì trả về CREATE_EXPENSE. '
